 ...
 * @description 我的优惠卷列表
 */
public class CouponListFragment extends ZBaseFragment implements ZBaseRecyclerViewAdapter.OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
     ...
     */
    public static CouponListFragment newInstance(String bean) {
